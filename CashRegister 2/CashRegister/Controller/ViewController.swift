...
class ViewController: UIViewController, UITableViewDelegate,
    ...
    override func viewDidLoad() {
        ...
        products = (UIApplication.shared.delegate as! AppDelegate).productList
        addProductQuantity = (UIApplication.shared.delegate as! AppDelegate).addProduct
        updateProductQuantity = (UIApplication.shared.delegate as! AppDelegate).deleteProduct
        purchasedProduct = (UIApplication.shared.delegate as! AppDelegate).purchaseCollection
    }
   ...
   func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.productType.text = products!.allProducts[indexPath.row].productName
        cell.productQuantity.text = String(products!.allProducts[indexPath.row].productQuantity)
        cell.productPrice.text = String(products!.allProducts[indexPath.row].productPrice)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        productType.text = products!.allProducts[indexPath.row].productName
      ...
      //check if the product type is displayed, if not an error alert is displayed to user
        if productType.text == "Type"{
            ...
            for p in products!.allProducts{
                if p.productName == productType.text{
                    if p.productQuantity < Int(displayQuantity)!{
                        ...
                        totalPrice.text = String(Double(displayQuantity)! * p.productPrice)
                    }
                }
            }
        }
